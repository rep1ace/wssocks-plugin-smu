# wssocks-ustb 简介
为了访问校内网络，可通过 [https://github.com/rep1ace/wssocks-plugin-smu](https://github.com/rep1ace/wssocks-plugin-smu) 工具进行连接。
...
[https://github.com/rep1ace/wssocks](https://github.com/rep1ace/wssocks) 实现了 SOCKS5 代理协议，并将代理的数据包用 websocket 协议进行包装。 
...
因此，还开发了一个 wssocks 插件，[https://github.com/rep1ace/wssocks-plugin-smu/](https://github.com/rep1ace/wssocks-plugin-smu/) ，用于登录学校 vpn 服务。
